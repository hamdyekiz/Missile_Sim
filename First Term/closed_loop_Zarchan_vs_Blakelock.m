...
while T <= (TF-.00001)
    ...
    DELC = XKR*(X+THD);                          % Derivative of the deflection angle
...
% Plotting
figure
plot(ArrayT,ArrayXNL, 'g-' ,ArrayT,ArrayXCG , 'r--');
grid on; 
xlabel('Time (Sec)')
ylabel('Acceleration (G) ')
legend('Missile Acceleration', 'Commanded Acceleration'); 
title(sprintf(' Control System Step Response (Transfer Function: %d)', user_index));
