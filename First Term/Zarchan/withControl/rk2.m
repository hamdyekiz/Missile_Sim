...
R_Mx = 40000.;                                                              % Missile Position X-Component (ft)
R_My = 15000.;                                                           % Missile Position Y-Component (ft) 
R_Tx = 20000.;                                                          % Target Position X-Component (ft)
R_Ty = 10000.;                                                          % Target Position Y-Component (ft)
V_M = 1500.;                                                            % Velocity of the missile (ft/s)
V_T = 1000.;                                                            % Velocity of the target (ft/s)
Beta = 5.;                                                              % Angle of the target velocity (degree)
...
% Run Simulink
simOut = sim('proportional_NavSimulinkV1');
...
%-------------------------------------------------------------------------- 
% Simulation (Runge Kutta 2nd Order)
%-------------------------------------------------------------------------- 
